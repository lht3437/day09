			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						<input type="hidden" name="id" id="abc" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>爱好：</td>
								<td>
								<input type="checkbox" id="expressTrait1" name="expressTrait" value="耐心"/>耐心
								<input type="checkbox" id="expressTrait2" name="expressTrait" value="干练"/>干练
								<input type="checkbox" id="expressTrait3" name="expressTrait" value="效率"/>效率
								</td>
							</tr>
							<tr>
								<td>入职时间：</td>
